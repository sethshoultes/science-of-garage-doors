...
define( 'SOGD_PLUGIN_DIR', plugin_dir_path( __FILE__ ) );
define( 'SOGD_PLUGIN_BASENAME', plugin_basename( __FILE__ ) );

// GitHub-based auto-updater.
require_once SOGD_PLUGIN_DIR . 'includes/class-updater.php';
SOGD_Updater::init();
